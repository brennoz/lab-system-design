...
public class ProviderAAdapter extends AbstractProviderAdapter {

    public ProviderAAdapter(RestTemplate restTemplate, String baseUrl, ObjectMapper mapper) {
        super(restTemplate, baseUrl, mapper);
    }

    @Override
    public String providerId() { return "PROVIDER_A"; }

    @Override
    @CircuitBreaker(name = "providerA")
